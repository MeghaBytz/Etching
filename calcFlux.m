...
fluxVx_O2 = nO2m*sqrt((8*ee*Te/(pi*MO2)))/4; %cm^2/s
fluxVx_O = nO*sqrt((8*ee*Te/(pi*MO)))/4; %cm^2/s
fluxVx_O2plus = nOplus*final_uB_O2/(2*pi)*1e-4;
fluxVz_O2plus=nOplus*final_uB_O2*1e-4;
fluxVx_Oplus=nOplus*final_uB_O/(2*pi)*1e-4;
fluxVz_Oplus=nOplus*final_uB_O*1e-4;
fluxVx = [fluxVx_O2 fluxVx_O fluxVx_O2plus fluxVx_Oplus]
