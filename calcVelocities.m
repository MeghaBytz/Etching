...
Vx = calcEtchRate(Te,fluxVx,current)/1000/100;%divide by 100 to normalize for -100 to 100 grid and divide by 10 to normalize
%calc vertical velocity
Vy = calcEtchRate(Te,fluxVz,current)/1000/100; %divide by 1000 for um
assignin('base', 'Vy', Vy)
    assignin('base', 'Vx', Vx)
end